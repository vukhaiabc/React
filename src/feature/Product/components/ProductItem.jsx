    ...
    return (
        <Box className={classes.productitem} onClick={handleClick}>
            ...
            <Box sx={{
                ...
                <Typography>Đã bán {product.amount_sold}</Typography>
            </Box>
            <Box sx={{
                display: 'flex',
                alignItems:'baseline',
            ...
            <Button variant="contained" color="success" fullWidth>Mua Ngay</Button>
            {product.hot && <Box className={classes.favourite}>Hot</Box>}

            {product.sale_percent > 0 && <Box className={classes.sale}>{product.sale_percent}% GIẢM</Box>}
